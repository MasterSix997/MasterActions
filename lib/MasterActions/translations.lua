Translation = {
    menu = {
        ...
        description_prop_id = "",
        name_prop_attached = "",
        description_prop_attached = "",
        name_prop_bone = "",
        description_prop_bone = "",
        name_prop_bone_head = "",
        name_prop_bone_neck = "",
        name_prop_bone_spine = "",
        name_prop_bone_pelvis = "",
        name_prop_bone_left_arm = "",
        name_prop_bone_right_arm = "",
        name_prop_bone_left_leg = "",
        name_prop_bone_right_leg = "",
        name_prop_bone_left_foot = "",
        name_prop_bone_right_foot = "",
        name_position = "",
        name_rotation = "",
        name_additive = "",
...
local function lang_pt()
    return {
        menu = {
            ...
            name_prop_id = "Prop",
            description_prop_id = "",
            name_prop_attached = "Grudado",
            description_prop_attached = "",
            name_prop_bone = "Osso",
            description_prop_bone = "",
            name_prop_bone_head = "Cabeça",
            name_prop_bone_neck = "Pescoço",
            name_prop_bone_spine = "Espinha",
            name_prop_bone_pelvis = "Pélvis",
            name_prop_bone_left_arm = "Braço esquerdo",
            name_prop_bone_right_arm = "Braço direito",
            name_prop_bone_left_leg = "Perna esqueda",
            name_prop_bone_right_leg = "Perna direita",
            name_prop_bone_left_foot = "Pé esquerdo",
            name_prop_bone_right_foot = "Pé direito",
